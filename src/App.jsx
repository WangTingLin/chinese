...
const article4Blocks = [
  ...
  {
    type: "para",
    text: "王源，清初古文學者，受業於明末清初散文三大家之魏禧，又與桐城派諸儒交遊。其《左傳評》中引入兵法的「奇正」，並以「賓主」評點《左傳》。本文主要試圖分析書中的「奇正」與「賓主」的內涵，整理王源如何使用此二手法評點《左傳》，並釐清「奇正」與「賓主」間的關聯性及其得失，由以分析《左傳評》之閱讀策略。",
  },
  {
    type: "para",
    text: "關鍵詞：王源、左傳評、奇正、賓主",
  },
  {
    type: "heading",
    text: "前言",
