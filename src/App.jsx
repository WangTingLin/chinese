...
export default function App() {
  ...
  return (
    <div style={{
      ...
      <button
        onClick={scrollToTop}
        className="fixed bottom-6 right-6 md:bottom-10 md:right-10 p-3.5 rounded-full shadow-2xl spring-transition z-50 flex items-center justify-center border hover:-translate-y-2 hover:shadow-[0_10px_40px_rgba(0,0,0,0.3)] active:scale-95"
        style={{
